...
public class NewCookieHeaderDelegate implements RuntimeDelegate.HeaderDelegate {
    ...
    // the Netscape pattern is parsed with a two digit year so that both "24" and "2024" are accepted
    ...
    // RFC 6265 section 5.1.1: two digit years 70-99 are 19xx and 00-69 are 20xx
    ...
    static Date parseExpires(String value) {
        try {
            // asctime pads the day of month with a space, collapse the whitespace for SimpleDateFormat
