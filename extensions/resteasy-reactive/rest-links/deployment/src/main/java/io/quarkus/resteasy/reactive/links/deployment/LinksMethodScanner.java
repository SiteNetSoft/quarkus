...
public class LinksMethodScanner implements MethodScanner {
    ...
    public List<HandlerChainCustomizer> scan(MethodInfo method, ClassInfo actualEndpointClass,
        ...
        // the method carrying the Jakarta REST annotations may be declared on an interface or a superclass,
        // while the link annotations are placed on the overriding method that is actually invoked
