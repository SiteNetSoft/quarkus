    ...
    public static Rest5ClientBuilder createRestClientBuilder(ElasticsearchConfig config) {
        ...
        builder.setHttpClientConfigCallback(new Consumer<>() {
            ...
            public void accept(HttpAsyncClientBuilder httpClientBuilder) {
                ...
                Iterable<InstanceHandle<ElasticsearchClientConfigConfigurer>> handles = Arc.container()
                        .select(ElasticsearchClientConfigConfigurer.class, new ElasticsearchClientConfig.Literal())
                        .handles();
                for (InstanceHandle<ElasticsearchClientConfigConfigurer> handle : handles) {
